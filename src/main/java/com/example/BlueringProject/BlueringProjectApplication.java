...
public class BlueringProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		employee1.setPhoneNumber(Integer.valueOf(+961-123456));
		...
		employee2.setPhoneNumber(Integer.valueOf(+961-123456));
		...
		employee3.setPhoneNumber(Integer.valueOf(+961-123456));
		...
		employee4.setPhoneNumber(Integer.valueOf(+961-123456));
		...
		employee5.setPhoneNumber(Integer.valueOf(+961-123456));
